...
export default function Users({ onClose }: { onClose: () => void }) {
    return (
        <div className="fixed inset-0 h-screen w-screen bg-black/50 flex z-[50] justify-center items-center py-20 ">
            <div className="bg-white w-[50%] min-h-[50dvh] p-8 rounded-sm max-h-[90dvh] overflow-auto">
                ...
                <ul className="my-5 ">
                    {
                        [...Array(10)].map(
                            (key) => {
                                return (
                                    <li key={key} className="flex justify-between gap-10 items-center border-b py-4 hover:bg-slate-100 cursor-pointer px-2">
                                        <div className="">
                                            <div className="flex gap-4 items-center">
                                                <div className="h-16 w-16 bg-slate-100 overflow-hidden rounded-full flex justify-center items-center">
                                                ...
                                                <div className="">
                                                    <h2 className="text-xl font-semibold capitalize">Surendra Upreti</h2>
                                                    <p>@surendra9812</p>
                                                </div>
                                            </div>
                                        </div>
